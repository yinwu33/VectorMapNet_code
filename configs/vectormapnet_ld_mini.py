...
point_cloud_range = [-10, -25, -1.0, 100, 25, 3.0]
...
# rasterize params
roi_size = (200, 200)  # unit: meter, annotation range, means 100m left, 100m right, 100m front, 100m back
...
data = dict(
    ...
    train=dict(
        type='LDDatasetMini',
        data_root='/home/yinwu/Data/InnovizOne_MT/LD_DATASET_ROOT/seg1/lidar',
        ann_file='/home/yinwu/Workspace/LiangDao/algorithm/workspace/vectormap_builder/map_infos.pkl',
        roi_size=roi_size,
        cat2id=class2label,
    ...
    val=dict(
        type='LDDatasetMini',
        data_root='/home/yinwu/Data/InnovizOne_MT/LD_DATASET_ROOT/seg1/lidar_one',
        ann_file='/home/yinwu/Workspace/LiangDao/algorithm/workspace/vectormap_builder/map_infos.pkl',
        roi_size=roi_size,
        cat2id=class2label,
        pipeline=train_pipeline,
